...
grep -E \
    'POI context:|POI activity density:|POI activity classifier:|POI activity sample:|POI accommodation check:|POI accommodation:|\[preprocess\].*(objects|done)|BUILD (COMPLETE|FAILED)|TOTAL' \
