...
osmium extract -O -v --progress --strategy=simple --polygon=../poly/RU-SAK.poly \
...
# --bounding-polygon file=../poly/RU-SAK.poly completeWays=yes \
# --write-pbf file=sak.osm.pbf \
# omitmetadata=true
...
date
 ...
 ../tools/osmosis/bin/osmosis \
 --read-pbf-fast sak.osm.pbf \
 --tag-transform file=../transform_places.xml \
 --write-pbf file=sak2.osm.pbf \
 omitmetadata=true
...
# ../tools/osmosis/bin/osmosis \
#    --read-pbf-fast sak2.osm.pbf \
#    --read-pbf-fast ../elevation/RU-SAK.osm.pbf \
#    --merge \
#    --write-pbf file=topo.sak.osm.pbf omitmetadata=true
...
cd sak
 ...
 java -jar ../../tools/splitter/splitter.jar ../topo.sak.osm.pbf \
 --description="topo-sak" \
 --polygon-file=../../poly/RU-SAK.poly \
...
timestamp=$(date +%d.%m.%Y)
 ...
 --family-id=1017 \
 --family-name="topo-sak" \
 --series-name="topo-sak" \
 --description="topo-sak ($timestamp)" \
 --overview-mapname="topo-sak" \
 --code-page=1251 \
 --gmapi \
...
cd ./garmin
mv gmapsupp.img topo-sak.img
cp topo-sak.img /mnt/nod/garmin

zip -r -0 -s=0 topo-sak-ms.zip ./topo-sak.gmap
cp topo-sak-ms.z* /mnt/nod/garmin/mapsource
