...
def test_primary_secondary_tertiary_link_roundabout_chains_stop_after_close_lod():
    expected_far = (
        "highway=primary_link | highway=primary & junction=roundabout [0x03 resolution 20-21 continue]",
        "highway=secondary_link | highway=secondary & junction=roundabout [0x07 resolution 20-21 continue]",
        "highway=tertiary_link | highway=tertiary & junction=roundabout [0x07 resolution 21-22 continue]",
    )
    expected_close = (
